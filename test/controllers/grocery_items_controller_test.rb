...
class GroceryItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update grocery_item" do
    patch grocery_item_url(@grocery_item), params: { grocery_item: { description: @grocery_item.description, name: @grocery_item.name, need: @grocery_item.need, qty: @grocery_item.qty, unit: @grocery_item.unit } }
