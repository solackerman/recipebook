  ...
  module V1
    class GroceryItemsController < ApplicationController
      ...
      def create
        ...
        respond_to do |format|
          if @grocery_item.save
            format.html { redirect_to api_v1_grocery_item_url(@grocery_item), notice: 'Grocery item was successfully created.' }
      ...
      def update
        respond_to do |format|
          if @grocery_item.update(grocery_item_params)
            format.html { redirect_to api_v1_grocery_item_url(@grocery_item), notice: 'Grocery item was successfully updated.' }
      ...
      def destroy
        ...
        respond_to do |format|
          format.html { redirect_to api_v1_grocery_items_url, notice: 'Grocery item was successfully destroyed.' }
